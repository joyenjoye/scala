...
- [List](#list)
  ...
  - [Implementations](#implementations)
    ...
    - [Remove](#remove)
    - [Flatten](#flatten)
  - [Tuples and Generic Methods](#tuples-and-generic-methods)
    - [Sorting Lists Faster](#sorting-lists-faster)
    - [Pair and Tuples](#pair-and-tuples)
    - [The Tuple classes](#the-tuple-classes)
    - [Making Sort More General](#making-sort-more-general)
  - [Higher Order List Function](#higher-order-list-function)
    - [Mapping](#mapping)
    - [Filtering](#filtering)
  ...
  - [Reasoning about Lists](#reasoning-about-lists)
    - [Natural Induction](#natural-induction)
      - [Example](#example)
    - [Structural Induction](#structural-induction)
      - [Example](#example-1)
      - [Exercise VI](#exercise-vi-1)
